&laquo;<span id="ppsPopupEditableLabelShell" title="<?php _e('Click to Edit', PPS_LANG_CODE)?>">
  ...
  <?php echo viewPps::ksesString(htmlPps::text('popup_label', [
...
<div id="ppsPopupSaveAsCopyWnd" style="display: none;">
  <form id="ppsPopupSaveAsCopyForm">
    <label>
      ...
      <?php echo viewPps::ksesString(htmlPps::text('copy_label', ['value' => $this->popup['label'] . ' ' . __('Copy', PPS_LANG_CODE), 'required' => true]))?>
    </label>
    <div id="ppsPopupSaveAsCopyMsg"></div>
    <?php echo viewPps::ksesString(htmlPps::hidden('mod', ['value' => 'popup']))?>
    <?php echo viewPps::ksesString(htmlPps::hidden('action', ['value' => 'saveAsCopy']))?>
    <?php echo viewPps::ksesString(htmlPps::hidden('id', ['value' => $this->popup['id']]))?>
