...
<div id="ppsOptInProWnd" style="display: none;" title="<?php _e('Improve Free version', PPS_LANG_CODE); ?>">
  <p id="ppsOptWndTemplateTxt" style="display: none;">
    <?php printf(
      __(
        'Please be advised that this template with all other options and PRO templates is available only in <a target="_blank" href="%s">PRO version</a>. You can <a target="_blank" href="%s" class="button">Get PRO</a> today and get this and other PRO templates and features for your PopUps!',
        PPS_LANG_CODE,
      ),
      $this->mainLink,
      $this->mainLink,
