        ...
        <div class="col-sm-8">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <p>
                <?php printf(
                  __("We love our plugin and do the best to improve all features for You. But sometimes issues happened, or you can't find required feature that you need. Don't worry, just <a href='%s' target='_blank'>contact us</a> and we will help you!", PPS_LANG_CODE),
