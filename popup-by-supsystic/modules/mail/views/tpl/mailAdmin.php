<form id="ppsMailTestForm">
  <label>
    ...
    <?php echo viewPps::ksesString(htmlPps::text('test_email', ['value' => $this->testEmail])); ?>
  </label>
  <?php echo viewPps::ksesString(htmlPps::hidden('mod', ['value' => 'mail'])); ?>
  <?php echo viewPps::ksesString(htmlPps::hidden('action', ['value' => 'testEmail'])); ?>
...
<form id="ppsMailSettingsForm">
    ...
    <tr>
      <th scope="row" class="col-w-30perc">
        ...
        <span class="description">
          <?php $opt['value'] ? printf(__('Turned On %s', PPS_LANG_CODE), datePps::_($opt['changed_on'])) : printf(__('Turned Off %s', PPS_LANG_CODE), datePps::_($opt['changed_on'])); ?>
        </span>
        <?php } ?>
      </th>
      ...
      <td class="col-w-1perc">
        <?php echo viewPps::ksesString(htmlPps::$htmlType('opt_values[' . $optKey . ']', ['value' => $opt['value'], 'attrs' => 'data-optkey="' . $optKey . '"'])); ?>
      </td>
  ...
  <?php echo viewPps::ksesString(htmlPps::hidden('mod', ['value' => 'mail'])); ?>
  <?php echo viewPps::ksesString(htmlPps::defaultNonceForAdminPanel()); ?>
  <?php echo viewPps::ksesString(htmlPps::hidden('action', ['value' => 'saveOptions'])); ?>
  <button class="button button-primary">
