jQuery(document).ready(function () {
  ...
  function sendSubscribeMail() {
    ...
    data = {};
    jQuery.each(
      jQuery("#overview-ac-form").serializeArray(),
      function (index, obj) {
    ...
    jQuery.ajax({
      ...
      success: function (response) {
        ...
        jQuery("#supsysticOverviewACFormDialog")
          .find(".message")
  ...
  jQuery("#subscribe-btn").on("click", function (e) {
    ...
    if (
      !$userMail.val() ||
      !$userName.val() ||
      !jQuery("#supsysticOverviewACTermsCheckbox").is(":checked")
    ) {
    ...
    jQuery(
      "#subscribe-btn, .supsysticOverviewACBtnRemind, .supsysticOverviewACBtnDisable"
    )
  ...
  function sendSubscribeRemind() {
    var defaultIconClass = jQuery(".supsysticOverviewACBtnRemind")
      .find("i")
      .attr("class");
    jQuery(".supsysticOverviewACBtnRemind")
      .find("i")
  ...
  function sendSubscribeDisable() {
    var defaultIconClass = jQuery(".supsysticOverviewACBtnDisable")
      .find("i")
      .attr("class");
    jQuery(".supsysticOverviewACBtnDisable")
      .find("i")
      .attr("class", "fa fa-spinner fa-spin");
  ...
  jQuery(".overview-section-btn").on("click", function () {
    ...
    jQuery(
      ".overview-section[data-section='" + jQuery(this).data("section") + "']"
    ).show();
    jQuery(".overview-section-btn-active").removeClass(
      "overview-section-btn-active"
    );
    jQuery(this).addClass("overview-section-btn-active");
  });
  jQuery(
    ".supsysticOverviewACBtnDisable, .supsysticOverviewACClose, .supsysticOverviewACBtnRemind"
  ).on("click", function () {
    jQuery(".supsysticOverviewACFormOverlay").fadeOut();
  });
