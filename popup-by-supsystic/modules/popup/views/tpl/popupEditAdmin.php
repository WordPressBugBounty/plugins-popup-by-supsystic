      ...
      <div id="containerWrapper">
        <form id="ppsPopupEditForm">
          ...
          <?php foreach ($this->popup['params']['opts_attrs'] as $optKey => $attr) {
            echo viewPps::ksesString(htmlPps::hidden('params[opts_attrs][' . $optKey . ']', ['value' => $attr]));
          }?>
          <?php }?>
          <?php echo viewPps::ksesString(htmlPps::hidden('mod', ['value' => 'popup']))?>
          <?php echo viewPps::ksesString(htmlPps::hidden('action', ['value' => 'save']))?>
