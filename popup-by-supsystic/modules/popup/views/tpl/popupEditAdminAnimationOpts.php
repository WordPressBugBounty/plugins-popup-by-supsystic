...
<div class="ppsPopupOptRow">
  <div id="ppsPopupAnimOptsShell">
    ...
    <?php if (isset($aData['old']) && $aData['old']) {
      continue;
    } ?>
  ...
  <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][anim_key]', ['value' => $this->popup['params']['tpl']['anim_key']])); ?>
  <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][anim_close_key]', ['value' => isset($this->popup['params']['tpl']['anim_close_key']) ? $this->popup['params']['tpl']['anim_close_key'] : ''])); ?>
</div>
<div class="ppsPopupOptRow ppsAnimOpenRow">
  <label>
    <?php _e('Animation Duration', PPS_LANG_CODE); ?>:
    <?php echo viewPps::ksesString(htmlPps::text('params[tpl][anim_duration]', ['value' => $this->popup['params']['tpl']['anim_duration']])); ?>
...
<div class="ppsPopupOptRow ppsAnimCloseRow">
  <label>
    ...
    <?php echo viewPps::ksesString(htmlPps::text('params[tpl][anim_close_duration]', ['value' => isset($this->popup['params']['tpl']['anim_close_duration']) ? $this->popup['params']['tpl']['anim_close_duration'] : ''])); ?>
    <?php _e('miliseconds', PPS_LANG_CODE); ?>
  </label>
</div>