<div id="supsystic-admin-tour" class="">
  ...
  <div id="supsystic-first_edit-popup_subscribe_opts">
    <div class="supsystic-tour-content">
      ...
      <p><?php printf(
        __(
          'Setup your Subscription settings here - select Subscribers destination in "Subscribe to" option - it allow to flow your subscribers not only to WordPress Users, but to other popular subscribe services. With other subscription options you will be able to easily customize your subscribe form in PopUp window.',
          PPS_LANG_CODE,
        ),
        PPS_WP_PLUGIN_NAME,
      ); ?></p>
  ...
  <div id="supsystic-first_edit-popup_statistics_opts">
    <div class="supsystic-tour-content">
      ...
      <p><?php printf(
        __(
          'After you will setup your PopUp - it will start displaying to your site visitors. And now - you need to check it\'s displaying statistics. Here, in Statistics tab, you will be able to see how many times PopUp was shown to your visitors, how many times visitors subscribed to it (if subscription is enabled), how many times visitors shared your site using Social Share PopUp functionality and what social networks for share is most popular (if it was enabled). If you will use AB Testing feature to increase your site popularity - you will see here all your main and tested PopUps statistics - in one graph or diagramm, - and this will provide you with all required information about your POpUp popularity!',
          PPS_LANG_CODE,
        ),
        PPS_WP_PLUGIN_NAME,
      ); ?></p>
  ...
  <div id="supsystic-first_edit-popup_code_opts">
    <div class="supsystic-tour-content">
      ...
      <p><?php printf(
        __(
          'In case you will need modify source CSS / HTML code of your PopUp - you can easily do this here. Just make sure that you know what you are doing - don\'t break PopUp. You can also find additional information about editing source code <a href="%s" target="_blank">here</a>.',
          PPS_LANG_CODE,
        ),
        'http://supsystic.com/edit-popup-html-css-code/',
      ); ?></p>
    </div>
    <div class="supsystic-tour-btns">
      <a href="#" class="close"><?php _e('Close', PPS_LANG_CODE); ?></a>
  ...
  <div id="supsystic-first_edit-final">
    <div class="supsystic-tour-content">
      ...
      <p><?php printf(
        ...
        $this->finishSiteLink,
        PPS_WP_PLUGIN_NAME,
        'https://wordpress.org/support/plugin/popup-by-supsystic',
        'https://supsystic.com/contact-us/',
        'http://supsystic.com/forum/popup-plugin/',
        'https://wordpress.org/support/view/plugin-reviews/popup-by-supsystic?rate=5#postform/',
