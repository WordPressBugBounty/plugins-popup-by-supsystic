...
class subscribeControllerPps extends controllerPps
{
  ...
  {
    reqPps::setVar('pps_email_confirmed_' . $popupId, '1', 'cookie', ['expire' => 999 * 24 * 60 * 60]);
  }
  ...
  public function getWpCsvList()
  {
    ...
    if ($popup) {
      $model->setWhere(['popup_id' => $popup['id']]);
    }
  ...
  {
    return ['getMailchimpLists', 'getWpCsvList'];
  }
}
