  ...
  <tr>
    ...
    <td>
      <?php echo viewPps::ksesString(
        htmlPps::text('params[tpl][stat_ga_code]', [
...
<span class="ppsOptLabel" style="min-height: 30px;">
  ...
  <div style="float: right;">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('stat_from_txt', ['placeholder' => __('From', PPS_LANG_CODE), 'attrs' => 'style="font-weight: normal;"'])); ?>
    <?php echo viewPps::ksesString(htmlPps::text('stat_to_txt', ['placeholder' => __('To', PPS_LANG_CODE), 'attrs' => 'style="font-weight: normal;"'])); ?>
  </div>
</span>
<hr>
...
<div style="float: right;">
  <span style="line-height: 30px;">
    ...
    |
    <a href="<?php echo viewPps::ksesString(uriPps::mod('statistics', 'getCsv', ['id' => $this->popup['id'], '_wpnonce' => wp_create_nonce('pps_nonce')])); ?>" target="_blank" class="button" id="ppsPopupStatExportCsv"><?php _e('Export to CSV', PPS_LANG_CODE); ?></a>
    |
  </span>
...
<table class="form-table" style="width: auto;">
  <tr>
    ...
    <td>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][dsbl_stats]', ['checked' => isset($this->popup['params']['tpl']['dsbl_stats']) ? $this->popup['params']['tpl']['dsbl_stats'] : false])); ?>
    </td>
  </tr>
</table>