<table class="form-table" style="width: auto;">
  ...
  <tr class="ppsVideoVimeoExtraShell">
    ...
    <td class="col-w-1perc">
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][video_extra_full_screen]', [
  ...
  <tr>
    ...
    <td class="col-w-1perc" colspan="3">
      ...
      <?php } else {
        echo viewPps::ksesString(htmlPps::hidden('params[tpl][width_measure]', ['value' => 'px']));
      }?>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="col-w-1perc">
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][video_autoplay]', [
  ...
  <tr>
    ...
    <td class="col-w-1perc">
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][vide_hide_controls]', [
  ...
  <tr>
    ...
    <td class="col-w-1perc" colspan="4">
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][fb_enb_label]', [
  ...
  <tr>
    ...
    <td class="col-w-1perc">
      <?php echo viewPps::ksesString(htmlPps::selectbox('params[tpl][bg_overlay_type]', [
    ...
    <td class="col-w-1perc">
      <div class="ppsBgOverlaySets ppsBgOverlaySets_color">
        <?php echo viewPps::ksesString(htmlPps::colorpicker('params[tpl][bg_overlay_color]', [
      ...
      <div class="ppsBgOverlaySets ppsBgOverlaySets_img">
        <?php echo viewPps::ksesString(htmlPps::imgGalleryBtn('params[tpl][bg_overlay_img]', [
        ...
        <label>
          ...
          <?php echo viewPps::ksesString(htmlPps::selectbox('params[tpl][bg_overlay_img_pos]', [
  ...
  <tr>
    ...
    <td class="col-w-1perc">
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][dsbl_wnd_scroll]', [
  ...
  <tr>
    ...
    <td class="col-w-1perc">
      <?php echo viewPps::ksesString(htmlPps::fontsList('params[tpl][font_label]', [
            'attrs' => 'class="ppsProOpt"',
    ...
    <td class="col-w-1perc" colspan="3">
      <?php echo viewPps::ksesString(htmlPps::colorpicker('params[tpl][label_font_color]', [
            'attrs' => 'class="ppsProOpt"',
  ...
  <tr>
    ...
    <td class="col-w-1perc">
      <?php echo viewPps::ksesString(htmlPps::fontsList('params[tpl][font_txt_' . $i . ']', [
                        'attrs' => 'class="ppsProOpt"',
    ...
    <td class="col-w-1perc" colspan="3">
      <?php echo viewPps::ksesString(htmlPps::colorpicker('params[tpl][text_font_color_' . $i . ']', [
                        'attrs' => 'class="ppsProOpt"',
  ...
  <tr>
    ...
    <td class="col-w-1perc">
      <?php echo viewPps::ksesString(htmlPps::fontsList('params[tpl][font_footer]', [
            'attrs' => 'class="ppsProOpt"',
    ...
    <td class="col-w-1perc" colspan="3">
      <?php echo viewPps::ksesString(htmlPps::colorpicker('params[tpl][footer_font_color]', [
            'attrs' => 'class="ppsProOpt"',
  ...
  <tr>
    ...
    <td class="col-w-1perc">
      <label class="supsystic-tooltip" title="<?php _e('PopUp will be fully zoomed for smaller screens', PPS_LANG_CODE)?>">
        <?php echo viewPps::ksesString(htmlPps::radiobutton('params[tpl][responsive_mode]', [
        'value' => 'def',
  ...
  <tr>
    ...
    <td colspan="4">
      <?php echo viewPps::ksesString(htmlPps::text('params[tpl][reidrect_on_close]', [
    ...
    'attrs' => 'placeholder="http://example.com" style="width: 100%;"',
      ...
      <label>
        <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][reidrect_on_close_new_wnd]', [
      ...
      <label class="supsystic-tooltip">
        ...
        <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][close_redirect_to_btn_url]', [
  ...
  <tr>
    ...
    <td colspan="4">
      <?php echo viewPps::ksesString(htmlPps::text('params[tpl][iframe_display_only]', [
