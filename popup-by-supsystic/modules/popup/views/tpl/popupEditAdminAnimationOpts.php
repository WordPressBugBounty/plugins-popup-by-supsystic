...
<div class="ppsPopupOptRow">
  ...
  <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][anim_close_key]', ['value' => isset($this->popup['params']['tpl']['anim_close_key'])
...
<div class="ppsPopupOptRow ppsAnimCloseRow">
  <label>
    ...
    <?php echo viewPps::ksesString(htmlPps::text('params[tpl][anim_close_duration]', ['value' => isset($this->popup['params']['tpl']['anim_close_duration'])
