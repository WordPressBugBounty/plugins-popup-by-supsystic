...
$warnings = [];
if (isset($this->popup['params']['opts_attrs']['txt_block_number']) && !empty($this->popup['params']['opts_attrs']['txt_block_number'])) {
  for ($i = 0; $i < $this->popup['params']['opts_attrs']['txt_block_number']; $i++) {
    if (isset($this->popup['params']['tpl']['txt_' . $i]) && !empty($this->popup['params']['tpl']['txt_' . $i]) && strpos($this->popup['params']['tpl']['txt_' . $i], '[google_map_easy') !== false && !class_exists('frameGmp')) {
      $warnings[] = sprintf(
        __('You are using Google Maps in this PopUp, but don\'t have Google Maps Easy plugin installed. You can get it for Free from WordPress site <a target="_blank" href="%s">here</a>, install and start using this PopUp with map.', PPS_LANG_CODE),
...
<section class="ppsPopupMainOptSect">
  ...
  <label class="ppsPopupMainOptLbl" data-name="When page loads">
    <?php echo viewPps::ksesString(
      htmlPps::radiobutton('params[main][show_on]', [
        'value' => 'page_load',
  ...
  <div id="ppsOptDesc_params_main_show_on_page_load" style="display: none;" class="ppsOptDescParamsShell">
    <label>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_on_page_load_enb_delay]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on_page_load_enb_delay')])); ?>
      <?php _e('Delay for', PPS_LANG_CODE); ?>
    </label>
    <label>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_on_page_load_delay]', ['value' => $this->popup['params']['main']['show_on_page_load_delay']])); ?>
      <span class="supsystic-tooltip" title="<?php _e('Seconds', PPS_LANG_CODE); ?>"><?php _e('sec', PPS_LANG_CODE); ?></span>
    </label><br />
    <label class="ppsPageGlobalDelayShell supsystic-tooltip-right" title="<?php _e(
      'If this option will be enabled - time, entered above, will start counting from first page load, and if page will be reloaded (user will visit other site page for example) - it will be still counting from point, where it stopped on prev. page',
      PPS_LANG_CODE,
    ); ?>">
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][enb_page_load_global_delay]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'enb_page_load_global_delay')])); ?>
  ...
  <div id="ppsOptDesc_params_main_show_on_click_on_element" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('ppsCopyTextCode', ['value' => esc_html('[' . PPS_SHORTCODE_CLICK . ' id=' . $this->popup['id'] . ']'), 'attrs' => 'data-parent-selector=".ppsPopupMainOptSect" class="ppsCopyTextCode supsystic-tooltip-right"'])); ?>
    <br />
    ...
    <?php echo viewPps::ksesString(htmlPps::text('ppsCopyTextCode', ['value' => esc_html('#ppsShowPopUp_' . $this->popup['id']), 'attrs' => 'data-parent-selector=".ppsPopupMainOptSect" class="ppsCopyTextCode"'])); ?><br />
    ...
    <label>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_on_click_on_el_enb_delay]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on_click_on_el_enb_delay')])); ?>
      <?php _e('Delay for', PPS_LANG_CODE); ?>
    </label>
    <label>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_on_click_on_el_delay]', ['value' => isset($this->popup['params']['main']['show_on_click_on_el_delay']) ? $this->popup['params']['main']['show_on_click_on_el_delay'] : 0])); ?>
      <span class="supsystic-tooltip" title="<?php _e('Seconds', PPS_LANG_CODE); ?>"><?php _e('sec', PPS_LANG_CODE); ?></span>
    </label>
  </div><br />
  ...
  <div id="ppsOptDesc_params_main_show_on_scroll_window" style="display: none;" class="ppsOptDescParamsShell">
    <label>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_on_scroll_window_enb_delay]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on_scroll_window_enb_delay')])); ?>
      <?php _e('Delay for', PPS_LANG_CODE); ?>
    </label>
    <label>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_on_scroll_window_delay]', ['value' => isset($this->popup['params']['main']['show_on_scroll_window_delay']) ? $this->popup['params']['main']['show_on_scroll_window_delay'] : 0])); ?>
      <?php _e('seconds after first scroll', PPS_LANG_CODE); ?>
    </label><br />
    <label>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_on_scroll_window_enb_perc_scroll]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on_scroll_window_enb_perc_scroll')])); ?>
      <?php _e('Scrolled to', PPS_LANG_CODE); ?>
    </label>
    <label>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_on_scroll_window_perc_scroll]', ['value' => isset($this->popup['params']['main']['show_on_scroll_window_perc_scroll']) ? $this->popup['params']['main']['show_on_scroll_window_perc_scroll'] : 0])); ?>
      <?php _e('percents of total scroll', PPS_LANG_CODE); ?>
    </label>
  </div><br />
  <label class="ppsPopupMainOptLbl" data-name="On Exit from Site">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'on_exit', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'on_exit')])); ?>
  ...
  <label class="ppsPopupMainOptLbl" data-name="Bottom of the page">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'page_bottom', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'page_bottom')])); ?>
  ...
  <label class="ppsPopupMainOptLbl" data-name="After Inactivity">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'after_inactive', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'after_inactive')])); ?>
  ...
  <div id="ppsOptDesc_params_main_show_on_after_inactive" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <?php echo viewPps::ksesString(
      htmlPps::text('params[main][show_on_after_inactive_value]', [
        'value' => isset($this->popup['params']['main']['show_on_after_inactive_value']) ? $this->popup['params']['main']['show_on_after_inactive_value'] : 10,
        /*Default - 5 seconds*/
      ]),
    ); ?>
    <span class="supsystic-tooltip" title="<?php _e('Seconds', PPS_LANG_CODE); ?>"><?php _e('sec', PPS_LANG_CODE); ?></span>
  ...
  <label class="ppsPopupMainOptLbl" data-name="After User Comment">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'after_comment', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'after_comment')])); ?>
  ...
  <label class="ppsPopupMainOptLbl" data-name="After Purchasing (Checkout)">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'after_checkout', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'after_checkout')])); ?>
  ...
  <div id="ppsOptDesc_params_main_show_on_after_checkout" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('ppsCopyTextCode', ['value' => esc_html('[' . PPS_SHORTCODE . ' id=' . $this->popup['id'] . ']'), 'attrs' => 'class="ppsCopyTextCode"'])); ?><br />
    <?php _e('Or, if you are using your own html/php for this page - insert there next code', PPS_LANG_CODE); ?>:
    <?php echo viewPps::ksesString(htmlPps::textarea('ppsCopyTextCode', ['value' => esc_html($this->afterCheckoutCode), 'attrs' => 'class="ppsCopyTextCode"'])); ?>
  </div><?php } ?><br />
  <label class="ppsPopupMainOptLbl" data-name="On Link Follow">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'link_follow', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'link_follow')])); ?>
    <?php $openByFollowExl = get_bloginfo('wpurl') . '#ppsShowPopUp_' . $this->popup['id']; ?>
  ...
  <div id="ppsOptDesc_params_main_show_on_link_follow" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('ppsCopyTextCode', ['value' => esc_html('#ppsShowPopUp_' . $this->popup['id']), 'attrs' => 'class="ppsCopyTextCode"'])); ?><br />
    <label>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_on_link_follow_enb_delay]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on_link_follow_enb_delay')])); ?>
      <?php _e('Delay for', PPS_LANG_CODE); ?>
    </label>
    <label>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_on_link_follow_delay]', ['value' => isset($this->popup['params']['main']['show_on_link_follow_delay']) ? $this->popup['params']['main']['show_on_link_follow_delay'] : 0])); ?>
      <span class="supsystic-tooltip" title="<?php _e('Seconds', PPS_LANG_CODE); ?>"><?php _e('sec', PPS_LANG_CODE); ?></span>
    </label>
  </div><br />
  <label class="ppsPopupMainOptLbl" data-name="Build-In Page">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'build_in_page', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'build_in_page')])); ?>
    <?php $openByFollowExl = get_bloginfo('wpurl') . '#ppsShowPopUp_' . $this->popup['id']; ?>
  ...
  <div id="ppsOptDesc_params_main_show_on_build_in_page" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('ppsCopyTextCode', ['value' => esc_html('[' . PPS_SHORTCODE_BUILD_IN . ' id=' . $this->popup['id'] . ']'), 'attrs' => 'data-parent-selector=".ppsPopupMainOptSect" class="ppsCopyTextCode"'])); ?>
  </div><br />
  <label class="ppsPopupMainOptLbl" data-name="AdBlock Detected">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'adblock_detected', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'adblock_detected')])); ?>
  ...
  <label class="ppsPopupMainOptLbl" data-name="Show in Admin Area">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_in_admin_area]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_in_admin_area')])); ?>
  ...
  <label class="ppsPopupMainOptLbl" data-name="Visit several Pages">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'visit_several_pages', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_on', 'visit_several_pages')])); ?>
  ...
  <div id="ppsOptDesc_params_main_show_on_visit_several_pages" style="display: none;" class="ppsOptDescParamsShell supsystic-tooltip-right" title="<?php _e('Enter here number of pages that need to be visited by user before PopUp will be shown.', PPS_LANG_CODE); ?>">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('params[main][visit_page_cnt]', ['value' => isset($this->popup['params']['main']['visit_page_cnt']) ? $this->popup['params']['main']['visit_page_cnt'] : '', 'attrs' => 'class=""'])); ?>
  </div><br />
</section>
<section class="ppsPopupMainOptSect">
  ...
  <label class="ppsPopupMainOptLbl" data-name="After user close it">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][close_on]', ['value' => 'user_close', 'checked' => !isset($this->popup['params']['main']['close_on']) ? true : htmlPps::checkedOpt($this->popup['params']['main'], 'close_on', 'user_close')])); ?>
    <?php _e('After user close it', PPS_LANG_CODE); ?>
  </label><br />
  <label class="ppsPopupMainOptLbl" data-name="Click outside PopUp">
    <?php echo viewPps::ksesString(
      htmlPps::radiobutton('params[main][close_on]', [
        'value' => 'overlay_click',
  ...
  <label class="ppsPopupMainOptLbl" data-name="Only after action (Subscribe / Share / Like)">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][close_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'after_action', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'close_on', 'after_action')])); ?>
  ...
  <div id="ppsOptDesc_params_main_close_on_after_action" class="ppsOptDesc_params_main_close_on ppsPopupMainOptDesc ppsOptDescParamsShell" style="display: none;">
    <label>
      ...
      <?php echo viewPps::ksesString(
        htmlPps::text('params[main][close_on_after_action_time]', ['value' => isset($this->popup['params']['main']['close_on_after_action_time']) ? $this->popup['params']['main']['close_on_after_action_time'] : 1, /*Default - 1 second*/ 'attrs' => 'style="width: 60px;"']),
      ); ?>
      <span class="supsystic-tooltip" title="<?php _e('Seconds', PPS_LANG_CODE); ?>"><?php _e('sec', PPS_LANG_CODE); ?></span>
    </label><br />
    <label>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][close_on_after_action_enb_close_btn]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'close_on_after_action_enb_close_btn')])); ?>
  ...
  <label class="supsystic-tooltip-bottom ppsPopupMainOptLbl" data-name="After time passed" title="<?php echo esc_html(__('Close PopUp after it will be visible during specified time.', PPS_LANG_CODE)); ?>">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][close_on]', ['attrs' => 'class="ppsProOpt"', 'value' => 'after_time', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'close_on', 'after_time')])); ?>
  ...
  <div id="ppsOptDesc_params_main_close_on_after_time" class="ppsOptDesc_params_main_close_on ppsPopupMainOptDesc ppsOptDescParamsShell" style="display: none;">
    <label>
      <?php _e('Close after', PPS_LANG_CODE); ?>
      <?php echo viewPps::ksesString(
        htmlPps::text('params[main][close_on_after_time_value]', [
          'value' => isset($this->popup['params']['main']['close_on_after_time_value']) ? $this->popup['params']['main']['close_on_after_time_value'] : 5,
          /*Default - 5 seconds*/
        ]),
      ); ?>
      <span class="supsystic-tooltip" title="<?php _e('Seconds', PPS_LANG_CODE); ?>"><?php _e('sec', PPS_LANG_CODE); ?></span>
    ...
    <label>
      ...
      <div style="margin:10px 0px;">
        <?php echo viewPps::ksesString(htmlPps::colorpicker('params[tpl][bg_close_notice_font_color]', ['value' => isset($this->popup['params']['tpl']['bg_close_notice_font_color']) ? $this->popup['params']['tpl']['bg_close_notice_font_color'] : '#101010;'])); ?>
      </div>
    </label>
  </div><?php } ?><br />
  ...
  <label class="ppsPopupMainOptLbl" data-name="All pages">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_pages]', ['value' => 'all', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_pages', 'all')])); ?>
    <?php _e('All pages', PPS_LANG_CODE); ?>
  </label><br />
  <label class="ppsPopupMainOptLbl" data-name="Show on next pages / posts">
    <?php echo viewPps::ksesString(
      htmlPps::radiobutton('params[main][show_pages]', [
        'value' => 'show_on_pages',
  ...
  <div id="ppsOptDesc_params_main_show_pages_show_on_pages" style="display: none;" class="ppsOptDescParamsShell">
    <?php echo viewPps::ksesString(htmlPps::selectlist('show_pages_list', ['options' => $this->allPagesForSelect, 'value' => $this->selectedShowPages, 'attrs' => 'class="chosen chosen-responsive" data-placeholder="' . __('Choose Pages', PPS_LANG_CODE) . '"'])); ?>
  </div><br />
  <label class="ppsPopupMainOptLbl" data-name="Don\'t show on next pages / posts">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_pages]', ['value' => 'not_show_on_pages', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_pages', 'not_show_on_pages')])); ?>
  ...
  <div id="ppsOptDesc_params_main_show_pages_not_show_on_pages" style="display: none;" class="ppsOptDescParamsShell">
    <?php echo viewPps::ksesString(htmlPps::selectlist('not_show_pages_list', ['options' => $this->allPagesForSelect, 'value' => $this->selectedHidePages, 'attrs' => 'class="chosen chosen-responsive" data-placeholder="' . __('Choose Pages', PPS_LANG_CODE) . '"'])); ?>
  </div><br />
  <label class="ppsPopupMainOptLbl" data-name="Show on next categories">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_pages]', ['value' => 'show_on_categories', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_pages', 'show_on_categories')])); ?>
  ...
  <div id="ppsOptDesc_params_main_show_pages_show_on_categories" style="display: none;" class="ppsOptDescParamsShell">
    <?php echo viewPps::ksesString(htmlPps::selectlist('show_categories_list', ['options' => $this->allCategoriesForSelect, 'value' => $this->selectedShowCategories, 'attrs' => 'class="chosen chosen-responsive" data-placeholder="' . __('Choose Categories', PPS_LANG_CODE) . '"'])); ?>
  </div><br />
  <label class="ppsPopupMainOptLbl" data-name="Don\'t show on next categories">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_pages]', ['value' => 'not_show_on_categories', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_pages', 'not_show_on_categories')])); ?>
  ...
  <div id="ppsOptDesc_params_main_show_pages_not_show_on_categories" style="display: none;" class="ppsOptDescParamsShell">
    <?php echo viewPps::ksesString(htmlPps::selectlist('not_show_categories_list', ['options' => $this->allCategoriesForSelect, 'value' => $this->selectedHideCategories, 'attrs' => 'class="chosen chosen-responsive" data-placeholder="' . __('Choose Categories', PPS_LANG_CODE) . '"'])); ?>
  </div><br />
  <div style="clear: both;"></div>
  <span class="ppsOptLabel"><?php _e('Time display settings', PPS_LANG_CODE); ?></span>
  <hr />
  <label class="ppsPopupMainOptLbl">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][enb_show_time]', ['value' => 'all', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'enb_show_time')])); ?>
    <?php _e('Set display time', PPS_LANG_CODE); ?>
  </label><br />
  <span class="ppsTimeDisplayOptsShell">
    <?php _e('From', PPS_LANG_CODE); ?>
    <?php echo viewPps::ksesString(htmlPps::selectbox('params[main][show_time_from]', ['value' => isset($this->popup['params']['main']['show_time_from']) ? $this->popup['params']['main']['show_time_from'] : '', 'attrs' => 'class="time-choosen"', 'options' => $this->timeRange])); ?>
    <?php _e('to', PPS_LANG_CODE); ?>
    <?php echo viewPps::ksesString(htmlPps::selectbox('params[main][show_time_to]', ['value' => isset($this->popup['params']['main']['show_time_to']) ? $this->popup['params']['main']['show_time_to'] : '', 'attrs' => 'class="time-choosen"', 'options' => $this->timeRange])); ?>
  </span>
  <div style="clear: both;"></div>
  <span class="ppsOptLabel"><?php _e('Date display settings', PPS_LANG_CODE); ?></span>
  <hr />
  <label class="ppsPopupMainOptLbl">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][enb_show_date]', ['value' => 'all', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'enb_show_date')])); ?>
    <?php _e('Set display date', PPS_LANG_CODE); ?>
  </label><br />
  <span class="ppsDateDisplayOptsShell">
    <?php _e('From', PPS_LANG_CODE); ?>
    <?php echo viewPps::ksesString(htmlPps::text('params[main][show_date_from]', ['value' => isset($this->popup['params']['main']['show_date_from']) ? $this->popup['params']['main']['show_date_from'] : ''])); ?>
    <?php _e('to', PPS_LANG_CODE); ?>
    <?php echo viewPps::ksesString(htmlPps::text('params[main][show_date_to]', ['value' => isset($this->popup['params']['main']['show_date_to']) ? $this->popup['params']['main']['show_date_to'] : ''])); ?>
  </span>
  <div style="clear: both;"></div>
  <span class="ppsOptLabel"><?php _e('Days display settings', PPS_LANG_CODE); ?></span>
  <hr />
  <label class="ppsPopupMainOptLbl">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][enb_show_days]', ['value' => 'all', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'enb_show_days')])); ?>
    <?php _e('Set display days', PPS_LANG_CODE); ?>
  </label><br />
  <span class="ppsDaysDisplayOptsShell">
    <?php echo viewPps::ksesString(
      htmlPps::selectlist('params[main][show_days]', ['value' => isset($this->popup['params']['main']['show_days']) ? $this->popup['params']['main']['show_days'] : '', 'options' => $this->weekDaysRange, 'attrs' => 'class="chosen" data-placeholder="' . __('Select Days', PPS_LANG_CODE) . '"']),
    ); ?>
  </span>
</section>
<section class="ppsPopupMainOptSect">
  ...
  <label class="ppsPopupMainOptLbl" data-name="Everyone">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_to]', ['value' => 'everyone', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_to', 'everyone')])); ?>
    <?php _e('Everyone', PPS_LANG_CODE); ?>
  </label><br />
  <label class="ppsPopupMainOptLbl" data-name="For first-time visitors">
    <?php echo viewPps::ksesString(
      htmlPps::radiobutton('params[main][show_to]', [
  ...
  <div id="ppsOptDesc_params_main_show_to_first_time_visit" style="display: none;" class="ppsOptDescParamsShell">
    <label class="supsystic-tooltip-left" title="<?php _e('Will remember user visit for entered number of days and show PopUp to same user again - after this period. To remember only for one browser session - use 0 here, to remember forever - try to set big number - 99999 for example.'); ?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_to_first_time_visit_days]', ['value' => isset($this->popup['params']['main']['show_to_first_time_visit_days']) ? $this->popup['params']['main']['show_to_first_time_visit_days'] : 30, 'attrs' => 'style="width: 50px;"'])); ?>
  ...
  <label class="supsystic-tooltip-left ppsPopupMainOptLbl" data-name="Until user makes an action" title="<?php _e('Subscribe, share, like, etc.'); ?>">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_to]', ['value' => 'until_make_action', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_to', 'until_make_action')])); ?>
  ...
  <div id="ppsOptDesc_params_main_show_to_until_make_action" style="display: none;" class="ppsOptDescParamsShell">
    <label class="supsystic-tooltip-left" title="<?php _e('Will remember user action for entered number of days and show PopUp to same user again - after this period. To remember only for one browser session - use 0 here, to remember forever - try to set big number - 99999 for example.'); ?>">
      <?php _e('Remember for', PPS_LANG_CODE); ?>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_to_until_make_action_days]', ['value' => isset($this->popup['params']['main']['show_to_until_make_action_days']) ? $this->popup['params']['main']['show_to_until_make_action_days'] : 30, 'attrs' => 'style="width: 50px;"'])); ?>
      <span><?php _e('days', PPS_LANG_CODE); ?></span>
    </label>
  </div><br />
  <div class="ppsPopupMainOptLbl" data-name="Times in a period">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('params[main][count_times_num]', ['value' => isset($this->popup['params']['main']['count_times_num']) ? $this->popup['params']['main']['count_times_num'] : 1, 'attrs' => 'style="width: 40px;"'])); ?>
    <?php _e('times in a', PPS_LANG_CODE); ?>
    <?php echo viewPps::ksesString(
      htmlPps::selectbox('params[main][count_times_mes]', [
        'options' => ['hour' => __('hour', PPS_LANG_CODE), 'day' => __('day', PPS_LANG_CODE), 'week' => __('week', PPS_LANG_CODE), 'month' => __('month', PPS_LANG_CODE)],
  ...
  <label class="supsystic-tooltip-left ppsPopupMainOptLbl" data-name="Until user confirm email" title="<?php _e('Only after user will confirm email address - PopUp will disappear (for WordPress subscription for now).'); ?>">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_to]', ['value' => 'until_email_confirm', 'attrs' => 'class="ppsProOpt"', 'checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_to', 'until_email_confirm')])); ?>
  ...
  <label class="ppsPopupMainOptLbl" id="ppsHideForDevicesLabel">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE)); ?>">
      <a href="#" class="ppsSwitchShowHideOptLink" data-input-value="0" data-input-name="params[main][hide_for_devices_show]"><?php _e('Hide', PPS_LANG_CODE); ?></a>/<a href="#" class="ppsSwitchShowHideOptLink" data-input-value="1" data-input-name="params[main][hide_for_devices_show]"><?php _e(
  'Show Only',
  PPS_LANG_CODE,
); ?></a>
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_devices_show]', ['value' => isset($this->popup['params']['main']['hide_for_devices_show']) ? $this->popup['params']['main']['hide_for_devices_show'] : 0])); ?>
    </span>
    ...
    <?php echo viewPps::ksesString(
      htmlPps::selectlist('params[main][hide_for_devices][]', [
        'options' => $this->hideForList,
        'value' => isset($this->popup['params']['main']['hide_for_devices']) ? $this->popup['params']['main']['hide_for_devices'] : [],
  ...
  <label class="ppsPopupMainOptLbl ppsPopupMainOptLbl" id="ppsHideForPostTypesLabel">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE)); ?>">
      <a href="#" class="ppsSwitchShowHideOptLink" data-input-value="0" data-input-name="params[main][hide_for_post_types_show]"><?php _e(
        'Hide',
        PPS_LANG_CODE,
      ); ?></a>/<a href="#" class="ppsSwitchShowHideOptLink" data-input-value="1" data-input-name="params[main][hide_for_post_types_show]"><?php _e('Show Only', PPS_LANG_CODE); ?></a>
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_post_types_show]', ['value' => isset($this->popup['params']['main']['hide_for_post_types_show']) ? $this->popup['params']['main']['hide_for_post_types_show'] : 0])); ?>
    </span>
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(
      htmlPps::selectlist('params[main][hide_for_post_types][]', [
        'options' => $this->hideForPostTypesList,
        'value' => isset($this->popup['params']['main']['hide_for_post_types']) ? $this->popup['params']['main']['hide_for_post_types'] : [],
  ...
  <label class="ppsPopupMainOptLbl" style="display: inline; vertical-align: middle; padding-top: 12px;">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE)); ?>">
      <a href="#" class="ppsSwitchShowHideOptLink" data-input-value="0" data-input-name="params[main][hide_for_ips_show]"><?php _e('Hide', PPS_LANG_CODE); ?></a>/<a href="#" class="ppsSwitchShowHideOptLink" data-input-value="1" data-input-name="params[main][hide_for_ips_show]"><?php _e(
  'Show Only',
  PPS_LANG_CODE,
); ?></a>
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_ips_show]', ['value' => isset($this->popup['params']['main']['hide_for_ips_show']) ? $this->popup['params']['main']['hide_for_ips_show'] : 0])); ?>
    </span>
    ...
    <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_ips]', ['value' => isset($this->popup['params']['main']['hide_for_ips']) ? $this->popup['params']['main']['hide_for_ips'] : ''])); ?>
    <div id="ppsHiddenIpStaticList" class="alert alert-info" style="padding: 5px 0 0; margin: 0;"></div>
  </label><br />
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE)); ?>">
      <a href="#" class="ppsSwitchShowHideOptLink" data-input-value="0" data-input-name="params[main][hide_for_countries_show]"><?php _e('Hide', PPS_LANG_CODE); ?></a>/<a href="#" class="ppsSwitchShowHideOptLink" data-input-value="1" data-input-name="params[main][hide_for_countries_show]"><?php _e(
  'Show Only',
  PPS_LANG_CODE,
); ?></a>
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_countries_show]', ['value' => isset($this->popup['params']['main']['hide_for_countries_show']) ? $this->popup['params']['main']['hide_for_countries_show'] : 0])); ?>
    </span>
    <?php _e('for Countries', PPS_LANG_CODE); ?>
    <i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(
      sprintf(__('For those Countries PopUp will not be displayed (or vice versa - depending on Hide/Show Only option). Please be advised that your Country code is %s', PPS_LANG_CODE), $this->currentCountryCode ? $this->currentCountryCode : 'undefined (when using localhosts for example)'),
    ); ?>"></i>
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(
      htmlPps::selectlist('params[main][hide_for_countries][]', [
        'options' => $this->countriesForSelect,
        'value' => isset($this->popup['params']['main']['hide_for_countries']) ? $this->popup['params']['main']['hide_for_countries'] : [],
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE)); ?>">
      <a href="#" class="ppsSwitchShowHideOptLink" data-input-value="0" data-input-name="params[main][hide_for_languages_show]"><?php _e('Hide', PPS_LANG_CODE); ?></a>/<a href="#" class="ppsSwitchShowHideOptLink" data-input-value="1" data-input-name="params[main][hide_for_languages_show]"><?php _e(
  'Show Only',
  PPS_LANG_CODE,
); ?></a>
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_languages_show]', ['value' => isset($this->popup['params']['main']['hide_for_languages_show']) ? $this->popup['params']['main']['hide_for_languages_show'] : 0])); ?>
    </span>
    ...
    <?php echo viewPps::ksesString(
      htmlPps::selectlist('params[main][hide_for_languages][]', [
        'options' => $this->languagesForSelect,
        'value' => isset($this->popup['params']['main']['hide_for_languages']) ? $this->popup['params']['main']['hide_for_languages'] : [],
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE)); ?>">
      <a href="#" class="ppsSwitchShowHideOptLink" data-input-value="0" data-input-name="params[main][hide_search_engines_show]"><?php _e(
        'Hide',
        PPS_LANG_CODE,
      ); ?></a>/<a href="#" class="ppsSwitchShowHideOptLink" data-input-value="1" data-input-name="params[main][hide_search_engines_show]"><?php _e('Show Only', PPS_LANG_CODE); ?></a>
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_search_engines_show]', ['value' => isset($this->popup['params']['main']['hide_search_engines_show']) ? $this->popup['params']['main']['hide_search_engines_show'] : 0])); ?>
    </span>
    <?php _e('for Search Engines or Social Media', PPS_LANG_CODE); ?>
    <i class="fa fa-question supsystic-tooltip" title="<?php echo esc_html(
      __('If user coming from those Search Engines - PopUp will not be displayed. This is helpfull when you want to hide or show your PopUp only for users, who come to your site from particular search engine.', PPS_LANG_CODE),
    ); ?>"></i>
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(
      htmlPps::selectlist('params[main][hide_for_search_engines][]', [
        'options' => $this->searchEnginesSocialForSelect,
        'value' => isset($this->popup['params']['main']['hide_for_search_engines']) ? $this->popup['params']['main']['hide_for_search_engines'] : [],
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE)); ?>">
      <a href="#" class="ppsSwitchShowHideOptLink" data-input-value="0" data-input-name="params[main][hide_preg_url_show]"><?php _e('Hide', PPS_LANG_CODE); ?></a>/<a href="#" class="ppsSwitchShowHideOptLink" data-input-value="1" data-input-name="params[main][hide_preg_url_show]"><?php _e(
  'Show Only',
  PPS_LANG_CODE,
); ?></a>
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_preg_url_show]', ['value' => isset($this->popup['params']['main']['hide_preg_url_show']) ? $this->popup['params']['main']['hide_preg_url_show'] : 0])); ?>
    </span>
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(htmlPps::text('params[main][hide_preg_url]', ['value' => isset($this->popup['params']['main']['hide_preg_url']) ? $this->popup['params']['main']['hide_preg_url'] : '', 'attrs' => 'style="width: 100%; border: 1px solid #000;" class="ppsProOpt"'])); ?>
    <?php if (!$this->isPro) { ?>
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE)); ?>">
      <a href="#" class="ppsSwitchShowHideOptLink" data-input-value="0" data-input-name="params[main][hide_for_user_roles_show]"><?php _e(
        'Hide',
        PPS_LANG_CODE,
      ); ?></a>/<a href="#" class="ppsSwitchShowHideOptLink" data-input-value="1" data-input-name="params[main][hide_for_user_roles_show]"><?php _e('Show Only', PPS_LANG_CODE); ?></a>
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_user_roles_show]', ['value' => isset($this->popup['params']['main']['hide_for_user_roles_show']) ? $this->popup['params']['main']['hide_for_user_roles_show'] : 0])); ?>
    </span>
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(
      htmlPps::selectlist('params[main][hide_for_user_roles][]', [
        'options' => $this->userRolesForSelect,
        'value' => isset($this->popup['params']['main']['hide_for_user_roles']) ? $this->popup['params']['main']['hide_for_user_roles'] : [],
  ...
  <label class="ppsPopupMainOptLbl">
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(
      htmlPps::selectlist('params[main][groups][]', [
        'options' => $this->popupGroups,
        'value' => isset($this->popup['params']['main']['groups']) ? $this->popup['params']['main']['groups'] : [],
  ...
  <label class="supsystic-tooltip-left ppsPopupMainOptLbl" title="<?php _e('Hide PopUp for Logged-in users and show it only for not Logged-in site visitors.', PPS_LANG_CODE); ?>" style="">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][hide_for_logged_in]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'hide_for_logged_in')])); ?>
  ...
  <label class="supsystic-tooltip-left ppsPopupMainOptLbl" title="<?php _e('Show PopUp only for Logged-in users and hide it for not Logged-in site visitors.', PPS_LANG_CODE); ?>" style="">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_for_logged_in]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'show_for_logged_in')])); ?>
  ...
  <label class="supsystic-tooltip-left ppsPopupMainOptLbl" title="<?php _e('Hide active popups when displaying this popup.', PPS_LANG_CODE); ?>" style="">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][hide_other]', ['checked' => htmlPps::checkedOpt($this->popup['params']['main'], 'hide_other')])); ?>
...
<div id="ppsHideForIpWnd" style="display: none;" title="<?php _e('IPs List', PPS_LANG_CODE); ?>">
  <label>
    ...
    <?php echo viewPps::ksesString(htmlPps::textarea('hide_for_ips', ['attrs' => 'id="ppsHideForIpTxt" style="width: 100%; height: 300px;"'])); ?>
  </label>
</div>