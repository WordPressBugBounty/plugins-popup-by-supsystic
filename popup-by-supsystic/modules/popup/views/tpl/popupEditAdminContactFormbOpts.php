<?php if (!$this->contactFormSupported) {
  printf(
    __(
      'To start using this feature - you need to have Contact Form by Supsystic plugin installed on your site. It\'s free! You can find it <a href="%s" target="_blank" class="button" style="margin-top: -10px;">here</a>, install and active it, then reload this page - and you will be able to select your Contact Form.',
      PPS_LANG_CODE,
    ),
...
<div class="ppsPopupOptRow">
  <label>
    <?php echo viewPps::ksesString(
      htmlPps::checkbox('params[tpl][enb_contact_form]', [
    ...
    <tr>
      ...
      <td>
        <?php if (empty($this->contactFormsListForSelect)) {
          ...
          echo viewPps::ksesString(
            htmlPps::selectbox('params[tpl][contact_form]', [
