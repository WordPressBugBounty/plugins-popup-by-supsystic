...
<section class="ppsPopupMainOptSect">
  ...
  <label class="ppsPopupMainOptLbl" data-name="When page loads">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_on]', [
            'value' => 'page_load',
  ...
  <div id="ppsOptDesc_params_main_show_on_click_on_element" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('ppsCopyTextCode', [
    ...
    <label>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_on_click_on_el_delay]', [
  ...
  <div id="ppsOptDesc_params_main_show_on_after_inactive" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('params[main][show_on_after_inactive_value]', [
  ...
  <div id="ppsOptDesc_params_main_show_on_after_checkout" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <?php echo viewPps::ksesString(htmlPps::textarea('ppsCopyTextCode', [
...
?>
  ...
  <div id="ppsOptDesc_params_main_show_on_link_follow" style="display: none;" class="ppsOptDescParamsShell">
    ...
    <label>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_on_link_follow_delay]', [
...
?>
  ...
  <label class="ppsPopupMainOptLbl" data-name="Show in Admin Area">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_in_admin_area]', [
  ...
  <div id="ppsOptDesc_params_main_show_on_visit_several_pages" style="display: none;" class="ppsOptDescParamsShell supsystic-tooltip-right" title="<?php _e('Enter here number of pages that need to be visited by user before PopUp will be shown.', PPS_LANG_CODE)?>">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('params[main][visit_page_cnt]', [
...
<section class="ppsPopupMainOptSect">
  ...
  <label class="ppsPopupMainOptLbl" data-name="After user close it">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][close_on]', [
    'value' => 'user_close',
  ...
  <div id="ppsOptDesc_params_main_close_on_after_action" class="ppsOptDesc_params_main_close_on ppsPopupMainOptDesc ppsOptDescParamsShell" style="display: none;">
    <label>
      ...
      <?php echo viewPps::ksesString(htmlPps::text('params[main][close_on_after_action_time]', [
    ...
    <label>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][close_on_after_action_enb_close_btn]', [
  ...
  <div id="ppsOptDesc_params_main_close_on_after_time" class="ppsOptDesc_params_main_close_on ppsPopupMainOptDesc ppsOptDescParamsShell" style="display: none;">
    <label>
      <?php _e('Close after', PPS_LANG_CODE)?>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][close_on_after_time_value]', [
    ...
    <label>
      ...
      <div style="margin:10px 0px;">
        <?php echo viewPps::ksesString(htmlPps::colorpicker('params[tpl][bg_close_notice_font_color]', [
  ...
  <label class="ppsPopupMainOptLbl" data-name="All pages">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_pages]', [
    'value' => 'all',
  ...
  <label class="ppsPopupMainOptLbl">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][enb_show_time]', [
    'value' => 'all',
  ...
  <span class="ppsTimeDisplayOptsShell">
    ...
    <?php echo viewPps::ksesString(htmlPps::selectbox('params[main][show_time_from]', [
    ...
    <?php echo viewPps::ksesString(htmlPps::selectbox('params[main][show_time_to]', [
  ...
  <hr />
  <label class="ppsPopupMainOptLbl">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][enb_show_date]', [
    'value' => 'all',
  ...
  <span class="ppsDateDisplayOptsShell">
    <?php _e('From', PPS_LANG_CODE)?>
    <?php echo viewPps::ksesString(htmlPps::text('params[main][show_date_from]', [
    'value' => (isset($this->popup['params']['main']['show_date_from']) ? $this->popup['params']['main']['show_date_from'] : ''),
]))?>
    <?php _e('to', PPS_LANG_CODE)?>
    <?php echo viewPps::ksesString(htmlPps::text('params[main][show_date_to]', [
  ...
  <hr />
  <label class="ppsPopupMainOptLbl">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][enb_show_days]', [
    'value' => 'all',
  ...
  <span class="ppsDaysDisplayOptsShell">
    <?php echo viewPps::ksesString(htmlPps::selectlist('params[main][show_days]', [
...
<section class="ppsPopupMainOptSect">
  ...
  <label class="ppsPopupMainOptLbl" data-name="Everyone">
    <?php echo viewPps::ksesString(htmlPps::radiobutton('params[main][show_to]', [
    'value' => 'everyone',
  ...
  <div id="ppsOptDesc_params_main_show_to_first_time_visit" style="display: none;" class="ppsOptDescParamsShell">
    <label class="supsystic-tooltip-left" title="<?php _e('Will remember user visit for entered number of days and show PopUp to same user again - after this period. To remember only for one browser session - use 0 here, to remember forever - try to set big number - 99999 for example.')?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_to_first_time_visit_days]', [
  ...
  <div id="ppsOptDesc_params_main_show_to_until_make_action" style="display: none;" class="ppsOptDescParamsShell">
    <label class="supsystic-tooltip-left" title="<?php _e('Will remember user action for entered number of days and show PopUp to same user again - after this period. To remember only for one browser session - use 0 here, to remember forever - try to set big number - 99999 for example.')?>">
      <?php _e('Remember for', PPS_LANG_CODE)?>
      <?php echo viewPps::ksesString(htmlPps::text('params[main][show_to_until_make_action_days]', [
  ...
  <div class="ppsPopupMainOptLbl" data-name="Times in a period">
    ...
    <?php echo viewPps::ksesString(htmlPps::text('params[main][count_times_num]', [
    ...
    <?php echo viewPps::ksesString(htmlPps::selectbox('params[main][count_times_mes]', [
    'options' => [
  ...
  <label class="ppsPopupMainOptLbl" id="ppsHideForDevicesLabel">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE))?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_devices_show]', [
    ...
    <?php echo viewPps::ksesString(htmlPps::selectlist('params[main][hide_for_devices][]', [
  ...
  <label class="ppsPopupMainOptLbl ppsPopupMainOptLbl" id="ppsHideForPostTypesLabel">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE))?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_post_types_show]', [
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(htmlPps::selectlist('params[main][hide_for_post_types][]', [
  ...
  <label class="ppsPopupMainOptLbl" style="display: inline; vertical-align: middle; padding-top: 12px;">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE))?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_ips_show]', [
    ...
    <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_ips]', [
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE))?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_countries_show]', [
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(htmlPps::selectlist('params[main][hide_for_countries][]', [
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE))?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_languages_show]', [
    ...
    <?php echo viewPps::ksesString(htmlPps::selectlist('params[main][hide_for_languages][]', [
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE))?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_search_engines_show]', [
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(htmlPps::selectlist('params[main][hide_for_search_engines][]', [
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE))?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_preg_url_show]', [
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(htmlPps::text('params[main][hide_preg_url]', [
  ...
  <label class="ppsPopupMainOptLbl">
    <span class="supsystic-tooltip" title="<?php echo esc_html(__('Click to revert feature function: from Hide - to Show, and vice versa.', PPS_LANG_CODE))?>">
      ...
      <?php echo viewPps::ksesString(htmlPps::hidden('params[main][hide_for_user_roles_show]', [
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(htmlPps::selectlist('params[main][hide_for_user_roles][]', [
  ...
  <label class="ppsPopupMainOptLbl">
    ...
    :<div style="padding-bottom: 5px; clear: both;"></div>
    <?php echo viewPps::ksesString(htmlPps::selectlist('params[main][groups][]', [
  ...
  <label class="supsystic-tooltip-left ppsPopupMainOptLbl" title="<?php _e('Hide PopUp for Logged-in users and show it only for not Logged-in site visitors.', PPS_LANG_CODE)?>" style="">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][hide_for_logged_in]', [
  ...
  <label class="supsystic-tooltip-left ppsPopupMainOptLbl" title="<?php _e('Show PopUp only for Logged-in users and hide it for not Logged-in site visitors.', PPS_LANG_CODE)?>" style="">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][show_for_logged_in]', [
  ...
  <label class="supsystic-tooltip-left ppsPopupMainOptLbl" title="<?php _e('Hide active popups when displaying this popup.', PPS_LANG_CODE)?>" style="">
    <?php echo viewPps::ksesString(htmlPps::checkbox('params[main][hide_other]', [
...
<div id="ppsHideForIpWnd" style="display: none;" title="<?php _e('IPs List', PPS_LANG_CODE)?>">
  <label>
    ...
    <?php echo viewPps::ksesString(htmlPps::textarea('hide_for_ips', [
