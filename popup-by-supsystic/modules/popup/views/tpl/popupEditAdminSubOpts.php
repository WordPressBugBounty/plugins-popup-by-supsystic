<div class="ppsPopupOptRow">
  <label>
    <?php echo viewPps::ksesString(
      htmlPps::checkbox('params[tpl][enb_subscribe]', [
...
<span data-block-to-switch="subShell">
  <table class="form-table ppsSubShellMainTbl" style="width: auto;">
    <tr>
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::selectbox('params[tpl][sub_dest]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_wordpress">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::selectbox('params[tpl][sub_wp_create_user_role]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_wordpress">
      <th scope="row">
        ...
        <i class="fa fa-question supsystic-tooltip" title="<?php _e(
          'Usually, after user subscribes, we send an email with the confirmation link - to confirm the email address, and only after user clicks on the link from this email - we will create a new subscriber. This option allows you to create a subscriber - right after subscription, without the email confirmation process.',
          PPS_LANG_CODE,
        ); ?>"></i>
      </th>
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::checkbox('params[tpl][sub_ignore_confirm]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_wordpress">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_confirm_reload_time]', [
            'value' => isset($this->popup['params']['tpl']['sub_confirm_reload_time']) ? $this->popup['params']['tpl']['sub_confirm_reload_time'] : 10,
          ]),
        ); ?>(sec)
      </td>
    </tr>
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_aweber">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_aweber_listname]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_aweber">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_aweber_adtracking]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_mailchimp">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_mailchimp_api_key]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_mailchimp">
      ...
      <td>
        <div id="ppsMailchimpListsShell" style="display: none;">
          <?php echo viewPps::ksesString(
            htmlPps::selectlist('params[tpl][sub_mailchimp_lists]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_mailchimp">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::checkbox('params[tpl][sub_dsbl_dbl_opt_id]', [
        ...
        <label id="ppsSubMcSendWelcome">
          <?php echo viewPps::ksesString(
            htmlPps::checkbox('params[tpl][sub_mc_enb_welcome]', [
              'checked' => htmlPps::checkedOpt($this->popup['params']['tpl'], 'sub_mc_enb_welcome'),
            ]),
          ); ?>
          <?php _e('Send MailChimp Welcome Email', PPS_LANG_CODE); ?>&nbsp;
          <i style="float: none;" class="fa fa-question supsystic-tooltip" title="<?php echo viewPps::ksesString(
            _e('If double opt-in is disable - there will be no Welcome email from MailChimp by default. But if you still need it - just enable this opton, and Welcome email from MailChimp will be sent to your user even in this case.', PPS_LANG_CODE),
          ); ?>"></i>
        </label>
      </td>
    </tr>
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_mailchimp">
      <th scope="row">
        ...
        <i class="fa fa-question supsystic-tooltip-bottom" title="<?php _e(
          'In MailChimp there are possibility to select groups for your subscribers. This is not mandatory, but some times is really helpful. So, we added this possibility for you in our plugin too - hope you will like it!',
          PPS_LANG_CODE,
        ); ?>"></i>
      </th>
      <td>
        <div id="ppsMailchimpGroupsShell" style="display: none;">
          <?php echo viewPps::ksesString(
            htmlPps::selectlist('params[tpl][sub_mailchimp_groups]', [
        ...
        <?php echo viewPps::ksesString(
          htmlPps::hidden('params[tpl][sub_mailchimp_groups_full]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_mailpoet">
      ...
      <td>
        ...
        <?php echo viewPps::ksesString(
          htmlPps::selectbox('params[tpl][sub_mailpoet_list]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_supsystic">
      ...
      <td>
        ...
        <?php echo viewPps::ksesString(
          htmlPps::selectbox('params[tpl][sub_supsystic_list]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_supsystic">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::checkbox('params[tpl][sub_sup_dsbl]', [
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_supsystic">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::checkbox('params[tpl][sub_sup_send_confirm]', [
    ...
    <?php
/*?><tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_newsletter">
...
?>
    ...
    <?php $proSubModules = [
      'constantcontact' => ['label' => __('Constant Contact', PPS_LANG_CODE)],
      'campaignmonitor' => ['label' => __('Campaign Monitor', PPS_LANG_CODE)],
      'get_response' => ['label' => __('GetResponse', PPS_LANG_CODE)],
      'icontact' => ['label' => __('iContact', PPS_LANG_CODE)],
      'verticalresponse' => ['label' => __('Vertical Response', PPS_LANG_CODE)],
      'activecampaign' => ['label' => __('Active Campaign', PPS_LANG_CODE)],
      'mailrelay' => ['label' => __('Mailrelay', PPS_LANG_CODE)],
      'sgautorepondeur' => ['label' => __('SG Autorepondeur', PPS_LANG_CODE)],
      'benchmarkemail' => ['label' => __('Benchmark', PPS_LANG_CODE)],
      'convertkit' => ['label' => __('ConvertKit', PPS_LANG_CODE)],
      'vision6' => ['label' => __('Vision6', PPS_LANG_CODE)],
      'ymlp' => ['label' => __('Your Mailing List Provider (Ymlp)', PPS_LANG_CODE)],
    ]; ?>
    <?php
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_<?php echo viewPps::ksesString($proSubMod); ?>">
      <th scope="row">
        ...
        <i class="fa fa-question supsystic-tooltip" title="<?php echo viewPps::ksesString(
          esc_html(
            __(
              'Apparently - you have installed PRO version, but did not activate it license - then please activate it. Or you have old version of plugin - then you need go to Plugins page and Update PRO version plugin, after this go to License tab and re-activate license (just click one more time on "Activate" button).',
              PPS_LANG_CODE,
            ),
          ),
        ); ?>"></i>
    ...
    <tr class="ppsPopupSubDestOpts ppsPopupSubDestOpts_<?php echo viewPps::ksesString($proSubMod); ?>">
              ...
              esc_html(
                sprintf(
                  ...
                  framePps::_()
                    ...
                    ->generateMainLink('utm_source=plugin&utm_medium=' . $proSubMod . '&utm_campaign=popup'),
                ),
              ),
            ); ?>
          </span>
      ...
      <td>
        <a href="<?php echo viewPps::ksesString(
          framePps::_()
            ->getModule('supsystic_promo')
            ->generateMainLink('utm_source=plugin&utm_medium=' . $proSubMod . '&utm_campaign=popup'),
        ); ?>" target="_blank" class="button"><?php _e('Get PRO', PPS_LANG_CODE); ?></a>
      </td>
    </tr>
    <?php } ?>
    <?php } ?>
    <tr>
      <input type="hidden" name="params[tpl][sub_enb_fb_subscribe]" value="">
    </tr>
    <tr class="ppsPopupSubCreateWpUser">
      <th scope="row">
        <?php _e('Create WP user', PPS_LANG_CODE); ?>
        <i class="fa fa-question supsystic-tooltip" title="<?php echo viewPps::ksesString(
          _e('Once user will subscribe to selected Subscription service - it will create WordPress Subscriber too. PLease be carefull using this option: WordPressusers will be created right after you submit your Subscribe form without confirmation.', PPS_LANG_CODE),
        ); ?>"></i>
      </th>
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::checkbox('params[tpl][sub_create_wp_user]', [
  ...
  <div class="ppsPopupOptRow">
    <fieldset id="ppoPopupSubFields" class="ppoPopupSubFields" style="padding: 10px;">
      ...
      <div
        ...
        <?php if ($k == 'email') {
          $checkParams = ['checked' => 1, 'disabled' => 1];
        } else {
          $checkParams = ['checked' => htmlPps::checkedOpt($f, 'enb')];
        } ?>
        ...
        <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][name]', ['value' => esc_html(isset($f['name']) ? $f['name'] : $k)])); ?>
        <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][html]', ['value' => esc_html($f['html'])])); ?>
        <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][label]', ['value' => esc_html($f['label'])])); ?>
        <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][value]', ['value' => esc_html(isset($f['value']) ? $f['value'] : '')])); ?>
        <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][custom]', ['value' => esc_html(isset($f['custom']) ? $f['custom'] : 0)])); ?>
        <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][mandatory]', ['value' => isset($f['mandatory']) ? $f['mandatory'] : 0])); ?>
        <?php echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][set_preset]', ['value' => isset($f['set_preset']) ? $f['set_preset'] : ''])); ?>
        <?php if (isset($f['options']) && !empty($f['options'])) {
          foreach ($f['options'] as $i => $opt) {
            echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][options][' . $i . '][name]', ['value' => esc_html($opt['name'])]));
            echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][options][' . $i . '][label]', ['value' => esc_html($opt['label'])]));
          }
        } ?>
        <?php if ($k == 'email') {
          // Email is always checked
          echo viewPps::ksesString(htmlPps::hidden('params[tpl][sub_fields][' . $k . '][enb]', ['value' => 1]));
        } ?>
      </div>
      <?php } ?>
      ...
      <div class="ppsReCaptchaShell">
        <label>
          <?php echo viewPps::ksesString(
            htmlPps::checkbox('params[tpl][enb_captcha]', [
        ...
        <div class="ppsReCaptchaOptsShell">
          <table class="form-table ppsSubShellOptsTbl">
            <tr>
              ...
              <td>
                <?php echo viewPps::ksesString(
                  htmlPps::text('params[tpl][capt_site_key]', [
  ...
  <table class="form-table ppsSubShellOptsTbl">
    <tr>
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::textarea('params[tpl][blacklist]', [
    ...
    <tr>
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][blacklist_error]', [
    ...
    <tr class="ppsPopupSubTxtsAndRedirect" style="display: none;">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_txt_confirm_sent]', [
    ...
    <tr class="ppsPopupSubTxtsAndRedirect" style="display: none;">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_txt_success]', [
    ...
    <tr class="ppsPopupSubTxtsAndRedirect" style="display: none;">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_txt_invalid_email]', [
    ...
    <tr class="ppsPopupSubTxtsAndRedirect" style="display: none;">
      <th scope="row">
        ...
        <i class="fa fa-question supsystic-tooltip" title="<?php _e(
          'If email that was entered by user already exists - user will see this message. But be careful: this can be used by hackers - to detect existing email in your database, so it\'s better for you to leave this message same as error message about invalid email above.',
          PPS_LANG_CODE,
        ); ?>"></i>
      </th>
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_txt_exists_email]', [
    ...
    <tr class="ppsPopupSubRedirect">
      <th scope="row">
        ...
        <i class="fa fa-question supsystic-tooltip" title="<?php _e(
          'You can enable redirection after subscription, just enter here URL that you want to redirect to after subscribe - and user will be redirected there. If you don\'t need this feature - just leave this field empty.',
          PPS_LANG_CODE,
        ); ?>"></i>
      </th>
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_redirect_url]', [
        ...
        <label>
          <?php echo viewPps::ksesString(
            htmlPps::checkbox('params[tpl][sub_redirect_new_wnd]', [
        ...
        <label class="supsystic-tooltip" title="<?php _e('If you set PopUp to Show On -> Click on certain link, and this link have href parameter - you can redirect your users there after successful subscribe.', PPS_LANG_CODE); ?>">
          <?php echo viewPps::ksesString(
            htmlPps::checkbox('params[tpl][sub_redirect_to_btn_url]', [
    ...
    <tr class="ppsPopupSubEmailTxt" style="display: none;">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_txt_confirm_mail_subject]', [
            'value' => esc_html(isset($this->popup['params']['tpl']['sub_txt_confirm_mail_subject']) ? $this->popup['params']['tpl']['sub_txt_confirm_mail_subject'] : __('Confirm subscription on [sitename]', PPS_LANG_CODE)),
          ]),
        ); ?>
      </td>
    </tr>
    <tr class="ppsPopupSubEmailTxt" style="display: none;">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_txt_confirm_mail_from]', [
            'value' => esc_html(isset($this->popup['params']['tpl']['sub_txt_confirm_mail_from']) ? $this->popup['params']['tpl']['sub_txt_confirm_mail_from'] : $this->adminEmail),
          ]),
        ); ?>
      </td>
    </tr>
    <tr class="ppsPopupSubEmailTxt" style="display: none;">
      <th scope="row">
        ...
        <?php $allowVarsInMail = ['sitename', 'siteurl', 'confirm_link', 'subscribe_url']; ?>
    ...
    <tr class="ppsPopupSubEmailTxt" style="display: none;">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_txt_subscriber_mail_subject]', [
            'value' => esc_html(isset($this->popup['params']['tpl']['sub_txt_subscriber_mail_subject']) ? $this->popup['params']['tpl']['sub_txt_subscriber_mail_subject'] : __('[sitename] Your username and password', PPS_LANG_CODE)),
          ]),
        ); ?>
      </td>
    </tr>
    <tr class="ppsPopupSubEmailTxt" style="display: none;">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_txt_subscriber_mail_from]', [
            'value' => esc_html(isset($this->popup['params']['tpl']['sub_txt_subscriber_mail_from']) ? $this->popup['params']['tpl']['sub_txt_subscriber_mail_from'] : $this->adminEmail),
          ]),
        ); ?>
      </td>
    </tr>
    <tr class="ppsPopupSubEmailTxt" style="display: none;">
      <th scope="row">
        ...
        <?php $allowVarsInMail = ['user_login', 'user_email', 'password', 'login_url', 'sitename', 'siteurl', 'subscribe_url']; ?>
        <?php if (isset($this->popup['params']['tpl']['sub_fields']) && !empty($this->popup['params']['tpl']['sub_fields'])) {
          foreach ($this->popup['params']['tpl']['sub_fields'] as $fName => $fData) {
            $allowVarsInMail[] = 'user_' . $fName;
          }
    ...
    <tr class="ppsPopupSubEmailTxt" style="display: none;">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_redirect_email_exists]', [
            'value' => esc_html(isset($this->popup['params']['tpl']['sub_redirect_email_exists']) ? $this->popup['params']['tpl']['sub_redirect_email_exists'] : ''),
            'attrs' => 'placeholder="http://example.com"',
          ]),
        ); ?>
      </td>
    ...
    <tr>
      ...
      <td>
        <?php echo viewPps::ksesString(htmlPps::text('params[tpl][sub_btn_label]', ['value' => $this->popup['params']['tpl']['sub_btn_label']])); ?>
      </td>
    </tr>
    <tr>
      <th scope="row">
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_new_email]', [
            'value' => isset($this->popup['params']['tpl']['sub_new_email']) ? $this->popup['params']['tpl']['sub_new_email'] : $this->adminEmail,
          ]),
        ); ?>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::text('params[tpl][sub_new_subject]', [
            'value' => isset($this->popup['params']['tpl']['sub_new_subject']) ? $this->popup['params']['tpl']['sub_new_subject'] : sprintf(__('New Subscriber on %s', PPS_LANG_CODE), wp_specialchars_decode(get_bloginfo('name'))),
          ]),
        ); ?>
      </td>
    </tr>
    <tr>
      <th scope="row">
        ...
        <?php $allowVarsInMail = ['sitename', 'siteurl', 'subscriber_data', 'subscribe_url']; ?>
        <div class="description" style=""><?php printf(__('You can use next variables here: %s', PPS_LANG_CODE), '[' . implode('], [', $allowVarsInMail) . ']'); ?></div>
      </th>
      <td>
        <?php echo viewPps::ksesString(
          htmlPps::textarea('params[tpl][sub_new_message]', [
            'value' => isset($this->popup['params']['tpl']['sub_new_message']) ? $this->popup['params']['tpl']['sub_new_message'] : __('You have new subscriber on your site <a href="[siteurl]">[sitename]</a>, here is subscriber information:<br />[subscriber_data]', PPS_LANG_CODE),
          ]),
        ); ?><br />
...
<div id="ppsPopupAttachShell" class="ppsPopupAttachShell">
  ...
  <?php echo viewPps::ksesString(
    htmlPps::hidden('params[tpl][sub_attach][]', [
      'disabled' => true,
    ]),
  ); ?>
