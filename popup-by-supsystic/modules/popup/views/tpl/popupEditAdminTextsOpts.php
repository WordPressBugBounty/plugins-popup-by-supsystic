...
<div class="ppsPopupOptRow">
  ...
  <?php echo viewPps::ksesString(htmlPps::text('params[tpl][label]', [
...
<fieldset>
  <legend>
    <label>
      ...
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][enb_txt_' . $i . ']', [
...
<fieldset>
  <legend>
    <label>
      ...
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][enb_btn_' . $i . ']', [
  ...
  <span data-block-to-switch="<?php echo viewPps::ksesString($switchBlock)?>">
    <table>
      <tr>
        ...
        <td><?php echo viewPps::ksesString(htmlPps::text('params[tpl][btn_txt_' . $i . ']', [
      ...
      <tr>
        ...
        <td>
          <?php echo viewPps::ksesString(htmlPps::text('params[tpl][btn_url_' . $i . ']', [
          ...
          <label>
            ...
            <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][is_close_btn_' . $i . ']', [
      ...
      <tr class="supsystic-tooltip" title="<?php _e('If it is primary - then it will be used when we check "Whom to Show" -> "Until user makes an action" condition.', PPS_LANG_CODE)?>">
        ...
        <td>
          <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][is_btn_primary_' . $i . ']', [
...
<fieldset>
  <legend>
    <label>
      <?php echo viewPps::ksesString(htmlPps::checkbox('params[tpl][enb_foot_note]', [
  ...
  <span data-block-to-switch="txtFooter">
    <?php echo viewPps::ksesString(htmlPps::textarea('params[tpl][foot_note]', [
