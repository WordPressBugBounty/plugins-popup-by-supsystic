<div class="ppsPopupOptRow">
  <label>
    <a target="_blank" href="<?php echo esc_html($this->promoLink); ?>" class="sup-promolink-input">
      <?php echo viewPps::ksesString(
        htmlPps::checkbox('layered_style_promo', [
          'checked' => 1,
  ...
  <div class="description"><?php _e(
    'By default all PopUps have modal style: it appears on user screen over the whole site. Layered style allows you to show your PopUp - on selected position: top, bottom, etc. and not over your site - but right near your content.',
    PPS_LANG_CODE,
  ); ?><br /><br /><?php _e('Notice: If you enable Layered style - background overlay for popup will not be displayed on frontend.', PPS_LANG_CODE); ?></div>
</div>
<span>
  <div class="ppsPopupOptRow">
...
<style type="text/css">
  ...
  .ppsLayeredPosCellContent:hover,
  .ppsLayeredPosCell.active .ppsLayeredPosCellContent {
    background-color: #e7f5f6;
    /*rgba(165, 182, 178, 0.3);*/
    color: #00575d;
  }
</style>
<!--PRO explanation Wnd-->
