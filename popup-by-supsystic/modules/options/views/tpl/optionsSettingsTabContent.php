...
<section>
  <form id="ppsSettingsForm" class="ppsInputsWithDescrForm">
    <div class="supsystic-item supsystic-panel">
      <div id="containerWrapper">
        <table class="form-table">
          ...
          $htmlOpts = ['value' => $opt['value'], 'attrs' => 'data-optkey="' . $optKey . '"'];
              ...
              <div id="ppsFormOptDetails_<?php echo esc_html($optKey); ?>" class="ppsOptDetailsShell">
                ...
                <?php if (isset($opt['add_sub_opts']) && !empty($opt['add_sub_opts'])) {
                  if (is_string($opt['add_sub_opts'])) {
                    ...
                    echo viewPps::ksesString(call_user_func_array($opt['add_sub_opts'], [$this->options]));
                  }
                } ?>
              </div>
            </td>
    ...
    <?php echo viewPps::ksesString(htmlPps::hidden('mod', ['value' => 'options'])); ?>
    <?php echo viewPps::ksesString(htmlPps::defaultNonceForAdminPanel()); ?>
    <?php echo viewPps::ksesString(htmlPps::hidden('action', ['value' => 'saveGroup'])); ?>
  </form>
</section>