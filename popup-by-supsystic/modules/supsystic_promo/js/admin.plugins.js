jQuery(document).ready(function () {
  var $deactivateLnk = jQuery(
    '#the-list tr[data-slug="' +
      ppsPluginsData.plugSlug +
  ...
  if ($deactivateLnk && $deactivateLnk.length) {
    ...
    var $wndButtonset = $deactivateWnd
    ...
    $deactivateForm.find('[name="deactivate_reason"]').change(function () {
      ...
      if (jQuery(this).prop("checked")) {
        var $descShell = jQuery(this)
          .parents(".ppsDeactivateReasonShell:first")
          .find(".ppsDeactivateDescShell");
