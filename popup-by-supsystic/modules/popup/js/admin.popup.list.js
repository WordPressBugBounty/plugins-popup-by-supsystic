jQuery(document).ready(function () {
  ...
  jQuery('#cb_' + tblId + '').change(function () {
    jQuery(this).prop('checked') ? jQuery('#ppsPopupRemoveGroupBtn').removeAttr('disabled') : jQuery('#ppsPopupRemoveGroupBtn').attr('disabled', 'disabled');
  });
  jQuery('#ppsPopupRemoveGroupBtn').click(function () {
    ...
    var confirmMsg = listIds.length > 1 ? toeLangPps('Are you sur want to remove ' + listIds.length + ' PopUps?') : toeLangPps('Are you sure want to remove "' + popupLabel + '" PopUp?');
